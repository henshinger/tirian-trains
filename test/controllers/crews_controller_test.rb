...
class CrewsControllerTest < ActionController::TestCase
  ...
  test "should create crew" do
    assert_difference('Crew.count') do
      post :create, crew: { given_name: @crew.given_name, last_name: @crew.last_name, last_name: @crew.last_name }
    end
  ...
  test "should update crew" do
    patch :update, id: @crew, crew: { given_name: @crew.given_name, last_name: @crew.last_name, last_name: @crew.last_name }
    assert_redirected_to crew_path(assigns(:crew))
  end
