class MaintenancesController < ApplicationController
  ...
  def new
    @maintenance = Maintenance.new(train_id: params[:train_id])
  end
  ...
  private
    ...
    def maintenance_params
      params.require(:maintenance).permit(:train_id, :crew_id, :maintenance_date, :maintenance_time, :task, :condition)
    end
end
