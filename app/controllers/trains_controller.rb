class TrainsController < ApplicationController
  ...
  # GET /trains/1.json
  def show
    @maintenances = @train.maintenances
  end
  ...
  private
    ...
    def train_params
      params.require(:train).permit(:model, :max_speed, :no_of_seats, :no_of_toilets, :reclining_seats, :folding_tables, :disability_access, :luggage_storage, :vending_machines, :food_service)
    end
end
